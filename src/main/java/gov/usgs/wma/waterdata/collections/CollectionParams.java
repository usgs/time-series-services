...
public class CollectionParams {
	...
	public static final String PARAM_NATIONAL_AQUIFER_CODE = "nationalAquiferCodes";
	public static final String PARAM_AGENCY_CODE = "agencyCodes";
	...
	public static class Builder {
		...
		public Map<String, Object> build() {
			...
			params = buildFilterableList(params, PARAM_NATIONAL_AQUIFER_CODE, nationalAquiferCodes, "&nationalAquiferCode=");
			params = buildFilterableList(params, PARAM_AGENCY_CODE, agencyCodes, "&agencyCode=");
